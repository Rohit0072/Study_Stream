...
function createWindow() {
    mainWindow = new electron_1.BrowserWindow({
        ...
        webPreferences: {
            ...
            webSecurity: false, // Disabled to allow CORS fetch requests to external APIs (HuggingFace, Pollinations, etc.)
        },
        show: false,
        frame: true,
...
electron_1.ipcMain.handle("send-notification", (event_1, _a) => __awaiter(void 0, [event_1, _a], void 0, function* (event, { title, body }) {
    new Promise(resolve => setTimeout(resolve, 100)); // micro-delay
...
electron_1.app.whenReady().then(() => {
    // Protocol handler removed in favor of HTTP server
    createWindow();
