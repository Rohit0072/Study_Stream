...
export const VideoPlayer = React.memo(({
    ...
    const handleBookmarkClick = () => {
        console.log('[VideoPlayer] Bookmark clicked');
        const video = videoRef.current;
        if (!video) {
            console.error('[VideoPlayer] Video ref is missing');
            return;
        }
        if (onBookmark) {
            console.log('[VideoPlayer] Calling onBookmark with time:', video.currentTime);
            onBookmark(video.currentTime);
        } else {
            console.error('[VideoPlayer] onBookmark prop is missing');
        }
    };
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-1 sm:gap-2">
                                ...
                                <div className="relative">
                                    ...
                                    {/* Bookmark Button */}
                                    <Button variant="ghost" size="icon" onClick={handleBookmarkClick} className="text-white hover:bg-white/10 h-8 w-8" title="Bookmark Timestamp">
