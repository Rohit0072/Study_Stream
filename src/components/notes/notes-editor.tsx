...
export function NotesEditor({ courseId, videoId, className, currentVideo }: NotesEditorProps) {
    ...
    const handleGenerateImage = async () => {
        ...
        try {
            const service = new ImageGenService(settings.geminiApiKey || "");
            const url = await service.generateImage(imagePrompt, imageModel);
                        ...
                        <div className="grid gap-2">
                            ...
                            <Select value={imageModel} onValueChange={(val: any) => setImageModel(val)}>
                                ...
                                <SelectContent className="bg-[#222] border-[#444] text-white">
                                    ...
                                    <SelectItem value="flux">Black Forest Labs Flux</SelectItem>
                                </SelectContent>
                            </Select>
                        </div>
                        <div className="grid gap-2">
