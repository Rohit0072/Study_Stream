                        ...
                        displayedFolders.length === 0 && (
                            <div className="flex flex-col items-center justify-center p-12 border border-dashed border-border rounded-lg bg-[#050505]">
                                <div className="h-12 w-12 rounded-full bg-secondary/50 flex items-center justify-center mb-4">
                                    {currentFolderId ? <FolderIcon className="h-6 w-6 text-muted-foreground" /> : <PlusCircle className="h-6 w-6 text-muted-foreground" />}
                                </div>
                                <h3 className="text-lg font-medium">{currentFolderId ? "Empty Folder" : "No courses found"}</h3>
                                <p className="text-muted-foreground text-sm max-w-xs text-center mt-2 mb-6">
                                    {currentFolderId ? "This folder is empty. Move courses here or add new ones." : "Start by adding a local folder containing your video course materials."}
                                </p>
                                {!currentFolderId && (
